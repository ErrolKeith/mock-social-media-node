...
export default class Search {
    ...
    constructor() {
        ...
        this.textInputField = document.querySelector("#live-search-field")
    ...
    //Events
    events(){
        this.textInputField.addEventListener("keyup", () => this.keyPressHandler())
        this.closeIcon.addEventListener("click", (event) => this.closeOverlay())
    ...
    //Methods
    keyPressHandler() {
        let value = this.textInputField.value
    ...
    sendRequest() {
        axios.post('/search', {_csrf: this._csrf, searchTerm: this.textInputField.value}).then(response => {
    ...
    openOverlay () {
        ...
        setTimeout(()=>{ this.textInputField.focus() }, 50)
    }
